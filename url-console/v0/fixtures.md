...
generated by `kernel.js` (itself verified byte-identical to
`urlcade.html` — see `test/check-kernel-sync.js`). Check your own
implementation or hand-computation against these directly; nothing
here requires running `urlcade.html`, a browser, or network access.
